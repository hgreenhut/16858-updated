...
public class CCWTurnByPID extends State {
    ...
    public CCWTurnByPID(StateMachine stateMachine, double angleTarget, double speed, ArrayList<DcMotor> motor, BNO055IMU IMU){
        super(stateMachine);
        driveSpeed = speed;
