...
public class CWTurnByPID extends State {
    ...
    public CWTurnByPID(StateMachine statemachine, double angleTarget, double speed, ArrayList<DcMotor> motor, BNO055IMU IMU){
        super(statemachine);
